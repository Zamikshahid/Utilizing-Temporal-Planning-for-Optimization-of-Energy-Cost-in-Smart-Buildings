...
;;;_____________________________Occupancy Schedule_______________________________;;;
 ...
 ;;working hours on problem file 2 is from 14:00 to 24:00
 
(not(Occupied))     ;;  occupied from 08:00 to 10:00 (LOW OCCUPANCY)
(NotOccupied)

 (at 8.05 (Occupied))  ;; occupied from working hours from 08:00
;(at 9 (Occupied))
;(at 10 (Occupied))
(at 10 (not(Occupied)))    ;; Not occupied from 10:00
;(at 12 (Occupied))         
;(at 13 (Occupied))
;(at 18 (not(Occupied)))   
